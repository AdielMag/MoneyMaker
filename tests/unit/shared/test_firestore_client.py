...
from shared.models import Position, TradingMode, Transaction, TransactionType, Wallet, WorkflowState
...
class TestWalletOperations:
    ...
    @pytest.mark.asyncio
    async def test_create_wallet_default_balance(self, firestore_client, mock_doc_ref, mock_settings):
...
class TestTransactionOperations:
    ...
    async def test_get_transactions(self, firestore_client):
        ...
        firestore_client.db.collection.return_value.where.return_value.order_by.return_value = mock_query
